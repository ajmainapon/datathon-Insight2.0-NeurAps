"""Insight 2.0 v6: round-2 pseudo-labeling from v4 (sub_005) test predictions.

Default LGBM params (LB-proven), 10-fold x 3 seeds, pseudo source = test_v4_blend.npy.

Usage: .venv/bin/python src/train_v6.py <sub_number> <description> <lo> <hi>
"""
import sys
import os
